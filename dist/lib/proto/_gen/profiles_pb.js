...
proto.profiles.v1.User.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    geocode: jspb.Message.getFieldWithDefault(msg, 9, "")
  };
...
/**
 * optional string geocode = 9;
 * @return {string}
 */
proto.profiles.v1.User.prototype.getGeocode = function() {
 ...
 * @return {!proto.profiles.v1.User} returns this
 */
proto.profiles.v1.User.prototype.setGeocode = function(value) {
